...
<template>
  <div>
    <div class="mb-2">Raw emails to normalize:</div>
    <c-input-text
    ...
    <div class="mb-2 mt-4">Normalized emails:</div>
    <c-input-text
    ...
    <div class="mt-4 flex justify-center gap-2">
      <c-button @click="emails = ''"> Clear emails </c-button>
      <c-button :disabled="!normalizedEmails" @click="copy()"> Copy normalized emails </c-button>
    </div>
  </div>
</template>
