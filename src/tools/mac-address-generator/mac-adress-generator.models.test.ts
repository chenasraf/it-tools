...
describe('mac-adress-generator models', () => {
  ...
  describe('generateRandomMacAddress', () => {
    ...
    it('generates a random mac address', () => {
      expect(generateRandomMacAddress({ getRandomByte: createRandomByteGenerator() })).toBe(
        '00:01:02:03:04:05',
      )
    })
    ...
    it('generates a random mac address with a prefix', () => {
      ...
      expect(
        generateRandomMacAddress({ prefix: 'ff:ee:a', getRandomByte: createRandomByteGenerator() }),
