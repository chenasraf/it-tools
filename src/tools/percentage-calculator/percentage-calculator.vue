...
<template>
  <div style="flex: 0 0 100%">
    <div style="margin: 0 auto; max-width: 600px">
      <c-card mb-3>
        <div mb-3 sm:hidden>What is</div>
        <div flex gap-2>
          <div hidden pt-1 sm:block style="min-width: 48px">What is</div>
          <n-input-number v-model:value="percentageX" data-test-id="percentageX" placeholder="X" />
          <div min-w-fit pt-1>% of</div>
      ...
      <c-card mb-3>
        <div mb-3 sm:hidden>X is what percent of Y</div>
        <div flex gap-2>
          <n-input-number v-model:value="numberX" data-test-id="numberX" placeholder="X" />
          <div hidden min-w-fit pt-1 sm:block>is what percent of</div>
      ...
      <c-card mb-3>
        <div mb-3>What is the percentage increase/decrease</div>
        <div flex gap-2>
