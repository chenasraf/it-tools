...
<template>
  <c-card>
    ...
    <div style="opacity: 0.8">Know which file extensions are associated to a mime-type</div>
    <c-select
  ...
  <c-card>
    ...
    <div style="opacity: 0.8">Know which mime type is associated to a file extension</div>
    <c-select
